...
/// </summary>
sealed internal class StateAction : System.IComparable<StateAction> {
    ...
    public StateAction(Item item, State state) {
        this.Item  = item;
        this.State = state;
    }

    /// <summary>Indicates if this action is a goto (true) or a shift (false).</summary>
    ...
    public int CompareTo(StateAction? other) {
