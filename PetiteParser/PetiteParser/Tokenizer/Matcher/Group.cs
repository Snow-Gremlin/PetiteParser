...
public class Group : IMatcher {
    ...
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddAll() => Add(new All());

    /// <summary>Adds a new not matcher.</summary>
    /// <param name="matchers">The initial matchers.</param>
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddNot(params IMatcher[] matchers) => Add(new NotGroup(matchers));

    /// <summary>Adds a new not matcher.</summary>
    /// <param name="matchers">The initial matchers.</param>
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddNot(IEnumerable<IMatcher> matchers) => Add(new NotGroup(matchers));
    ...
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddRange(string low, string high) => Add(new Range(low, high));

    /// <summary>Adds a new range matcher.</summary>
    /// <param name="low">The lower rune inclusively in the range.</param>
    /// <param name="high">The higher rune inclusively in the range.</param>
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddRange(char low, char high) => Add(new Range(low, high));

    /// <summary>Adds a new range matcher.</summary>
    /// <param name="low">The lower rune inclusively in the range.</param>
    /// <param name="high">The higher rune inclusively in the range.</param>
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddRange(Rune low, Rune high) => Add(new Range(low, high));
    ...
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddSet(string set) => Add(new CharSet(set));
    ...
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddSet(params char[] set) => Add(new CharSet(set));

    /// <summary>Adds a set matcher for all the characters in the given characters.</summary>
    /// <param name="set">The set of characters to match.</param>
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddSet(IEnumerable<char> set) => Add(new CharSet(set));
    ...
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddSet(params Rune[] set) => Add(new CharSet(set));

    /// <summary>Adds a set matcher for all the characters in the given runes.</summary>
    /// <param name="set">The set of runes to match.</param>
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddSet(IEnumerable<Rune> set) => Add(new CharSet(set));

    /// <summary>Adds a single matcher for the given character.</summary>
    /// <param name="singleChar">The character to match.</param>
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddSingle(char singleChar) => Add(new SingleChar(singleChar));

    /// <summary>Adds a single matcher for the given rune.</summary>
    /// <param name="single">The rune to match.</param>
    /// <returns>This group so that adds can be chained.</returns>
    public Group AddSingle(Rune singleChar) => Add(new SingleChar(singleChar));
    ...
    public override string ToString() => Matchers.Join(", ");
}
